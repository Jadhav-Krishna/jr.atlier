...
function page10() {
  ...
  document.querySelector("#circlee1").addEventListener("click", function () {
    ...
    para.textContent =
      "« I am delighted with the collaboration started with Julie for several years already. Very competent, at’ constantly listens to our needs and wishes. By its role of...";
  });
  ...
  document.querySelector("#circlee2").addEventListener("click", function () {
    ...
    para.textContent =
      "« With the accompaniment of Julie, our brand image finally reflects our adn and highlights our competitive advantages. New visual identity, new communication media...";
  });
  ...
  document.querySelector("#circlee3").addEventListener("click", function () {
    ...
    para.textContent =
      "« The meeting with Julie, started in 2017, around my need to renew the’ identity of our brand « Fruits at Home » and the packaging for the range of products Citron Caviar. La...";
  });

  document.querySelector("#circlee4").addEventListener("click", function () {
    icircle.setAttribute("src", "./p4.webp");
    name.textContent = "JESSICA ROLLAND";
    profile.textContent = "FOUNDER OF 1000 IDEAS PER MINUTE";
    job.textContent = "AGENCY SOMEDAY";
    para.textContent =
      "« Julie accompanied us in the development of our visual identity and guided us to proposals both creative and completely adapted to our universe. Beyond...";
  });

  document.querySelector("#circlee5").addEventListener("click", function () {
    icircle.setAttribute("src", "./p5.webp");
    name.textContent = "ETIENNE ROZAND";
    profile.textContent = "CHAIR";
    job.textContent = "MIAM FAMILY'S";
    para.textContent =
      "<< Excellent experience on our collaboration with Julie. Very happy for our brand Lipopette rendering around our visual identity and that of our sauces, it stuck...";
  });
  ...
  document.querySelector("#circlee6").addEventListener("click", function () {
    ...
    para.textContent =
      "“Julie Rignanese accompanied us in the creation and definition of the’ visual identity of our new concept of Vinyl Bar. She knew how to define our expectations, refocus our...";
  });
  ...
  document.querySelector("#circlee7").addEventListener("click", function () {
    ...
    para.textContent =
      "« Following my move to Lyon, I’ asked Julie to me’aider to rethink my entire communication strategy. She was great and went much further than...";
  });
  ...
  document.querySelector("#circlee8").addEventListener("click", function () {
    ...
    para.textContent =
      "« We entrusted Julie with the complete redesign of our graphic identity and its declination on our website.Beautiful remote collaboration : Julie is very pro, always good...";
  });
}
page10();
